...
## 2026-03-05 - Skip to Content Focus Management
...
**Action:** Always add `tabIndex={-1}` and remove the focus outline on target containers for skip links to ensure a smooth transition.
