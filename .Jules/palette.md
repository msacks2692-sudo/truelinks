...
## 2026-05-15 - Skip to Content Pattern for SPAs
...
**Action:** Implement this pattern (skip link with programmatic `.focus()` and target container with `tabIndex={-1}` and `outline: 'none'`) whenever building new SPA layouts.
